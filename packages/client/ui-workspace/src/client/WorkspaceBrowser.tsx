...
export function WorkspaceBrowser({
  ...
  // Delete is destructive: remove the session log durably with confirmation.
  ...
  const confirmSessionDelete = () => {
    ...
    setSessionDeleteError(null)
    const promise = deleteSession !== undefined
      ? deleteSession(sessionDeleteTarget.sessionId)
      : archiveSession(sessionDeleteTarget.sessionId)
    promise.then(() => {
